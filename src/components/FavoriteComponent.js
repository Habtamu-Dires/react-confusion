...
import { Button, Media , Breadcrumb, BreadcrumbItem} from "reactstrap";
    ...
    return (
        <Media tag="li">
            ...
            <Media body className='ml-5'>
                ...
                <Button outtline color="danger" onClick={() => deleteFavorite(dish._id)}>
...
const Favorites = (props) => {
    ...
    if(props.favorites.isLoading) {
        ...
        const favorites = props.favorites.favorites.dishes.map((dish) => {
            return (
                <div key={dish.dish._id} className="col-12 mt-5">
                    <RenderMenuItem dish={dish.dish} deleteFavorite={props.deleteFavorite} />
                </div>
            );
        });
